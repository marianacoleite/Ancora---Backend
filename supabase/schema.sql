-- Ancora — cola este ficheiro completo no Supabase: Dashboard → SQL → New query → Run
-- (Espelho de supabase/migrations/20260414120000_ancora_initial_schema.sql)
--
-- Executar uma vez. Se der erro "already exists", o esquema já foi criado.
...
-- ---------------------------------------------------------------------------
-- ancora_backend_test_runs (histórico de `npm test` gravado pelo script recordTestRun)
-- ---------------------------------------------------------------------------
